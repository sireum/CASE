...
SMACCM_DATA__Camera_Bounding_Box_i contents[1];
...
bool mon_dequeue(SMACCM_DATA__Camera_Bounding_Box_i * m) {
...
bool mon_enqueue(const SMACCM_DATA__Camera_Bounding_Box_i * m) {
